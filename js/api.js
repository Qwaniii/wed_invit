class Api {
    constructor() {
        // send to private 
        this.urlToCalendar = "https://api.telegram.org/bot7063713067:AAEOTHGN_x-StvgR7SGEUxcxTBOJKg6qXgs/sendMessage?chat_id=5200592838&text=";
        // send to group chat
    ...
    addToCalendar(name) {
        return fetch(`${this.urlToCalendar}${name}`, {
            method: "POST",
            headers: {
                "Accept": "application/json", 
                "Content-Type": "application/json"
